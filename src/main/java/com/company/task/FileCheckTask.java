...
public class FileCheckTask {
	...
	public void checkFiles() {
		...
		//stream -> Path stream
		Stream<Path> filePath = stream.map(vo -> Paths.get("g:\\upload", vo.getUploadPath(), vo.getUuid()+"_"+vo.getFileName()));
		...
		File targetDir = Paths.get("g:\\upload", getFolderYesterDay()).toFile();
