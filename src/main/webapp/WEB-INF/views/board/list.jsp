				...
				<table class="table table-striped table-bordered table-hover">
					...
					<tbody>
						<c:forEach var="vo" items="${list}">
							<tr>
								<td>${vo.bno}</td>
								<td><a href="${vo.bno}" class="move">${vo.title}</a><strong style="color:red">[${vo.replyCnt}]</strong></td>
								<td>${vo.writer}</td>
					...
					<div class="col-md-12">
						<div class="col-md-8">
							...
							<form action="" id="searchForm">
								...
								<input type="text" name="keyword" value="<c:out value="${pageVO.cri.keyword}"/>"/>
